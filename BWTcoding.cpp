...
// Takes text to be transformed and its length as arguments and returns the corresponding suffix array 
...
// Takes suffix array and its size as arguments and returns the Burrows - Wheeler Transform of given text 
...
{ 
    ...
    std::cout <<"Burrows - Wheeler Transform :"<<bwt_arr<<"\n"; 
    return 0; 
}